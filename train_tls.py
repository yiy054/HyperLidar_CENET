...
import yaml
import os
from modules.trainer_tls import Trainer
...
#         torch.backends.cudnn.deterministic = True
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='config/labels/semantic-tls.yaml',
    ...
    try:
        ...
        ARCH = yaml.safe_load(open('./'+FLAGS.arch_cfg, 'r', encoding="utf8"))
